DD_belatedPNG.fix('#feature,#feature .top_shadow, #feature .bottom_shadow,#footer,#footer_bottom,#footer .widget ul li,#footer .widget li a');
...
DD_belatedPNG.fix('.toggle_title,.ie_png,.picture_frame,.dropcap1,.dropcap2,ul.list1 li, ul.list2 li, ul.list3 li, ul.list4 li, ul.list5 li, ul.list6 li, ul.list7 li, ul.list8 li, ul.list9 li, ul.list10 li, ul.list11 li, ul.list12 li');
